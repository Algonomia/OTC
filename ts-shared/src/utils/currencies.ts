export namespace CurrenciesUtil {
    const SUPPORTED_CURRENCIES: ReadonlyArray<{code: string, symbol: string, name: string}> = [
        { code: 'AED', symbol: 'AED', name: 'United Arab Emirates Dirham' },
        { code: 'AFN', symbol: '؋', name: 'Afghan Afghani' },
        { code: 'ALL', symbol: 'Lek', name: 'Albanian Lek' },
        { code: 'AMD', symbol: 'Դ', name: 'Armenian Dram' },
        { code: 'ANG', symbol: 'ƒ', name: 'Netherlands Antillean Guilder' },
        { code: 'AOA', symbol: 'is', name: 'Angolan Kwanza' },
        ...
        { code: 'MGA', symbol: 'MK', name: 'Malagasy Ariary' },
        ...
        { code: 'MWK', symbol: '', name: 'Malawian Kwacha' },
        { code: 'MXN', symbol: '$', name: 'Mexican Peso' },
        { code: 'MXV', symbol: '', name: 'Mexican Investment Unit' },
        ...
        { code: 'USN', symbol: 'USN', name: 'United States Dollar (Next day)' },
        { code: 'UYI', symbol: 'UYI', name: 'Uruguay Peso en Unidades Indexadas' },
    ...
    export function getAllCurrencies() {
        return SUPPORTED_CURRENCIES.map(x => ({...x}));
    }
}
