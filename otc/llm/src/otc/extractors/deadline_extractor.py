...
__all__ = ["extract_deadline", "build_deadline_user_prompt"]


def build_deadline_user_prompt(
    ...
    _ = schema_cls
    _ = text
    return DEADLINE_USER_TEMPLATE.format(
...
def extract_deadline(
    ...
    task_context = build_deadline_user_prompt(
        schema_cls,
        text,
        jurisdiction,
        obligation_type,
