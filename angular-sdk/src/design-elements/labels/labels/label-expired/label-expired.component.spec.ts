...
import { LabelExpiredComponent } from './label-expired.component';
...
describe('LabelExpiredComponent', () => {
    let component: LabelExpiredComponent;
    let fixture: ComponentFixture<LabelExpiredComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(LabelExpiredComponent);
